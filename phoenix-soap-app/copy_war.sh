...
echo ""
echo "/etc/init.d/tomcat stop; sleep 4 && /bin/mv /usr/share/apache-tomcat-7.0.34/webapps/phoenix.war /home/phonex/phoenix.war.prev && /bin/cp /tmp/phoenix.war /usr/share/apache-tomcat-7.0.34/webapps/ && /bin/rm -rf /usr/share/apache-tomcat-7.0.34/webapps/phoenix && /etc/init.d/tomcat start"
