...
/**
 * Category manager bean
 * @author ph4r05
 */

@ManagedBean(name="categoryManagerBean")
@RequestScoped
@Scope(value="request")
@Service
@Repository
public class CategoryManagerBean implements Serializable {
    ...
    @Autowired
    protected transient CategoryBean categoryBean;
    ...
    protected CategoryViewModel newParent = null;
    protected CategoryViewModel newCategory = null;
    
    private String fulltextSearchQuery;
    private boolean searchInDescription=false;
    private List<CategoryFlattenWrapper> searchResult;
    ...
    public void initBean(){
        log.debug("PostConstructed CategoryManagerBean initialized");
    ...
    public void initCategories(){
        ...
        System.out.println("Category: " + rootForUser.toString());
    ...
    public void restoreFulltextSearch(){
        ...
        if (this.showAll){
            ...
            if (this.fulltextSearchQuery.isEmpty()){
                ...
                // query is not empty, get some results
                this.fulltextSearch();
            }
        }
    }
    ...
    /**
     * ADMIN method, reinitializes all fulltext indexes.
