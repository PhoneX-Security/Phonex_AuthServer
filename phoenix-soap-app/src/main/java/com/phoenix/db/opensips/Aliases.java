 ...
 */
@Entity
@Table(name = "aliases", catalog = "phoenixdb")
public class Aliases implements java.io.Serializable {
	...
	public Aliases(String username, String contact, Date expires, float q,
	...
	public Aliases(String username, String domain, String contact,
