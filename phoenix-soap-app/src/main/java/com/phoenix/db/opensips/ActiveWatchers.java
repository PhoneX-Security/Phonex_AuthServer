...
/**
 * ActiveWatchers generated by hbm2java
 */
@Entity
@Table(name = "active_watchers", catalog = "phoenixdb", uniqueConstraints = @UniqueConstraint(columnNames = {
		"presentity_uri", "callid", "to_tag", "from_tag" }))
public class ActiveWatchers implements java.io.Serializable {
	...
	public ActiveWatchers(String presentityUri, String watcherUsername,
			String watcherDomain, String toUser, String toDomain, String event,
