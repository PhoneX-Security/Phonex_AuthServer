...
public class StripedExecutorService extends AbstractExecutorService {
     ...
     */
    private final Map<Object, SerialExecutor> executors = new IdentityHashMap<Object, SerialExecutor>();
     ...
     */
    private final static ThreadLocal<Object> stripes = new ThreadLocal<Object>();
