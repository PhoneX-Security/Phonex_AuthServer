...
public final class SipUri {
    ...
    public static class ParsedSipContactInfos {
        ...
        public String toString(boolean includeDisplayName) {
            ...
            if (includeDisplayName && !isEmpty(displayName)) {
                // Prepend with space
    ...
    public static boolean isPhoneNumber(String phone) {
        return (!isEmpty(phone) && Pattern.matches(DIGIT_NBR_RULE, phone));
    }
